...
def build_presentation():
    ...
    def add_top_template_header(slide, title_text, slide_num):
        ...
        oval = slide.shapes.add_shape(MSO_SHAPE.OVAL, Inches(0.5), Inches(0.22), Inches(1.4), Inches(0.9))
        oval.fill.solid()
        ...
        banner_box = slide.shapes.add_textbox(Inches(2.1), Inches(0.22), Inches(8.8), Inches(0.9))
    ...
    # Top SIH 2026 header
    top_txt = s1.shapes.add_textbox(Inches(1.0), Inches(0.3), Inches(10.0), Inches(0.65))
    ...
    # Title
    t_box = s1.shapes.add_textbox(Inches(0.8), Inches(0.92), Inches(10.5), Inches(1.3))
    ...
    # Left: Details (Bigger Font: 13.5pt)
    details_box = s1.shapes.add_textbox(Inches(0.8), Inches(2.45), Inches(7.4), Inches(4.6))
    ...
    if os.path.exists(brain_img_path):
        s1.shapes.add_picture(brain_img_path, Inches(7.7), Inches(2.2), width=Inches(5.1))
    ...
    h1 = s2.shapes.add_textbox(Inches(0.6), Inches(1.25), Inches(6.4), Inches(0.5))
    htf = h1.text_frame
    hp = htf.paragraphs[0]
    ...
    # Bullets (Bigger Font: 12.5pt)
    b1 = s2.shapes.add_textbox(Inches(0.6), Inches(1.75), Inches(6.4), Inches(2.7))
    btf = b1.text_frame
    btf.word_wrap = True
    ...
    h2 = s2.shapes.add_textbox(Inches(0.6), Inches(4.55), Inches(6.4), Inches(0.45))
    htf2 = h2.text_frame
    ...
    b2 = s2.shapes.add_textbox(Inches(0.6), Inches(5.05), Inches(6.4), Inches(1.9))
    btf2 = b2.text_frame
    btf2.word_wrap = True
    ...
    p_extra.font.size = Pt(12.5)
    p_extra.font.color.rgb = TEXT_MAIN

    # Right: Foveated Concentric Circle Graphic (Enlarged to 5.1 inches!)
    c_out = s2.shapes.add_shape(MSO_SHAPE.OVAL, Inches(7.4), Inches(1.75), Inches(5.1), Inches(5.1))
    c_out.fill.solid()
    c_out.fill.fore_color.rgb = RGBColor(190, 220, 250)
    c_out.line.color.rgb = RGBColor(100, 160, 230)
    c_out.line.width = Pt(2.5)

    c_in = s2.shapes.add_shape(MSO_SHAPE.OVAL, Inches(8.7), Inches(3.05), Inches(2.5), Inches(2.5))
    c_in.fill.solid()
    c_in.fill.fore_color.rgb = RGBColor(20, 110, 200)
    c_in.line.color.rgb = RGBColor(10, 80, 160)
    c_in.line.width = Pt(2.5)

    v_dot = s2.shapes.add_shape(MSO_SHAPE.OVAL, Inches(9.7), Inches(4.05), Inches(0.52), Inches(0.52))
    v_dot.fill.solid()
    v_dot.fill.fore_color.rgb = WHITE
    v_dot.line.fill.background()

    c_title = s2.shapes.add_textbox(Inches(7.2), Inches(1.25), Inches(5.5), Inches(0.45))
    ...
    # Legend at bottom right (Bigger Font: 10.5pt)
    ...
    t_leg1.text_frame.paragraphs[0].font.size = Pt(10.5)
    ...
    t_leg2.text_frame.paragraphs[0].font.size = Pt(10.5)
    ...
    sw_title = s3.shapes.add_textbox(Inches(0.6), Inches(1.25), Inches(4.8), Inches(0.45))
    ...
    # Right: BIGGER 5-Panel System Dashboard Photo (Enlarged to 7.4 inches!)
    dash_path = r"C:\Users\HP\Desktop\SIH26053_Lidar\outputs\navigation_dashboard.png"
    if os.path.exists(dash_path):
        s3.shapes.add_picture(dash_path, Inches(5.4), Inches(1.3), width=Inches(7.4))

    tech_title = s3.shapes.add_textbox(Inches(5.4), Inches(5.1), Inches(7.4), Inches(0.35))
    tech_title.text_frame.margin_left = tech_title.text_frame.margin_top = 0
    tp = tech_title.text_frame.paragraphs[0]
    tp.text = "Technologies & Implementation:"
    tp.font.name = "Arial"
    tp.font.size = Pt(14)
    tp.font.bold = True
    tp.font.color.rgb = PILL_BLUE

    tech_box = s3.shapes.add_textbox(Inches(5.4), Inches(5.5), Inches(7.4), Inches(1.5))
    ttf = tech_box.text_frame
    ttf.word_wrap = True
    ttf.margin_left = ttf.margin_top = 0
    tech_list = [
        "• Python 3.12, NumPy (vectorized hashing), Open3D (point cloud processing)",
    ...
    def add_blue_pill(slide, text, left, top, width=Inches(2.3), height=Inches(0.48)):
    ...
    # Left: Feasibility & Challenges (Bigger Font: 11pt)
    ...
    add_blue_pill(s4, "Mitigation Strategy", Inches(6.7), Inches(1.25), Inches(2.7))
    m_box = s4.shapes.add_textbox(Inches(6.7), Inches(1.85), Inches(6.0), Inches(1.6))
    ...
    # Right: Autonomous Car Sensor Visual (Enlarged to 6.2 inches!)
    ...
    i_box = s5.shapes.add_textbox(Inches(0.6), Inches(1.82), Inches(4.8), Inches(1.6))
    ...
    add_blue_pill(s5, "Applications", Inches(0.6), Inches(3.55), Inches(2.3))
    a_box = s5.shapes.add_textbox(Inches(0.6), Inches(4.12), Inches(4.8), Inches(1.4))
    ...
    add_blue_pill(s5, "Benefits", Inches(0.6), Inches(5.35), Inches(2.1))
    ben_box = s5.shapes.add_textbox(Inches(0.6), Inches(5.9), Inches(4.8), Inches(1.3))
    ...
    # Right: BEFORE & AFTER PHOTOS (Enlarged to 3.55 inches each!)
    ...
    if os.path.exists(bef_img):
        ...
        lbl1 = s5.shapes.add_textbox(Inches(5.7), Inches(4.35), Inches(3.55), Inches(0.3))
    ...
    if os.path.exists(aft_img):
        ...
        lbl2 = s5.shapes.add_textbox(Inches(9.35), Inches(4.35), Inches(3.55), Inches(0.3))
    ...
    r_title1 = s6.shapes.add_textbox(Inches(0.6), Inches(1.25), Inches(4.5), Inches(0.4))
    ...
    r_title2 = s6.shapes.add_textbox(Inches(0.6), Inches(3.75), Inches(4.5), Inches(0.4))
    ...
    ref_box = s6.shapes.add_textbox(Inches(0.6), Inches(4.2), Inches(4.5), Inches(2.6))
    ...
    # Right: Numbered Research Pipeline Graphic (Enlarged to 7.8 inches!)
    if os.path.exists(pipeline_img_path):
        pipe_title = s6.shapes.add_textbox(Inches(5.3), Inches(1.22), Inches(7.7), Inches(0.4))
        ...
        pp.font.name = "Arial"
        pp.font.size = Pt(16.5)
        pp.font.bold = True
        pp.font.color.rgb = BLACK

        s6.shapes.add_picture(pipeline_img_path, Inches(5.2), Inches(1.75), width=Inches(7.8))

    deliv_box = s6.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(5.2), Inches(5.1), Inches(7.8), Inches(1.85))
    ...
    prs.save(out_pptx1)
    prs.save(out_pptx2)
    print("SUCCESS: Scaled up font sizes & enlarged images across all 6 slides!")
